...
# read the data
setwd("/Users/u351132/repos/ChangingThePicture/")
...
# some descriptives
length(unique(movcre$nconst)) # --> 3197 crew cornell datbase?
...
dims <- list()
l <- 0
for (i in 40246:length(movie_vec)) {
...
priorcollabs <- list()
for (i in 19626:length(movie_vec)) {
...
```{r nets, eval = FALSE}
setwd("/Users/u351132/repos/ChangingThePicture/")
write.csv(collabnets, "data/final_results/collabnets2.csv", sep = ";")
```
